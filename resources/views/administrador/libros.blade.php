...
@if (session('success-libros'))
    <div class="alert alert-success">
        {{ session('success-libros') }}
    </div>
@endif

@if (session('error-libros'))
    <div class="alert alert-danger">
        {{ session('error-libros') }}
    </div>
@endif
...
@if ($errors->any())
  <div class="alert alert-danger">
    @foreach ($errors->all() as $error)
      @if (strpos($error, 'isbn') !== false || strpos($error, 'titulo') !== false || strpos($error, 'portada') !== false || strpos($error, 'fechaPublicacion') !== false)
        <div>{{ $error }}</div>
      @endif
    @endforeach
  </div>
